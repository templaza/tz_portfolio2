		...
		<?php if ($params->get('link_titles')): ?>
            <?php
                if($params -> get('tz_portfolio_redirect') == 'p_article'){
                    $link = JRoute::_(TZ_PortfolioHelperRoute::getPortfolioArticleRoute($item->slug, $item->catid).$tmpl);
                }
                else{
                    $link = JRoute::_(TZ_PortfolioHelperRoute::getArticleRoute($item->slug, $item->catid).$tmpl);
                }
            ?>
		...
		<?php $author = ($item->created_by_alias ? $item->created_by_alias : $author);?>
			...
			<?php if ($params->get('link_author') == true):?>
				<?php 	echo JText::sprintf('COM_CONTENT_WRITTEN_BY' ,
				 JHtml::_('link', JRoute::_('index.php?option=com_tz_portfolio&amp;view=users&amp;created_by='.$item -> created_by), $author)); ?>
