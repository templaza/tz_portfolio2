...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	<?php if ($this->params->get('show_headings') || $this->params->get('filter_field','hide') != 'hide' || $this->params->get('show_pagination_limit',1)) :?>
		...
		<?php foreach ($this->items as $i => $article) : ?>
			...
			<?php endif; ?>
				<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
					...
					<td class="list-title">
						<a href="<?php echo JRoute::_(TZ_PortfolioHelperRoute::getArticleRoute($article->slug, $article->catid)); ?>">
				...
				<?php else : // Show unauth links. ?>
					<td>
						<?php
							...
							$returnURL = JRoute::_(TZ_PortfolioHelperRoute::getArticleRoute($article->slug));
