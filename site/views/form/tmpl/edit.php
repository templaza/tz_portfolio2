                        ...
                        <tr>
                            ...
                            <td>
                                <select name="tz_media_type" id="tz_media_type">
                                    ...
                                    <option value="youtube"<?php echo ($list -> video -> type =='youtube')?' selected="selected"':''?>><?php echo JText::_('Youtube');?></option>
                                    <option value="vimeo"<?php echo ($list -> video -> type =='vimeo')?' selected="selected"':''?>><?php echo JText::_('Vimeo');?></option>
                                </select>
                            </td>
                        </tr>
	...
	<fieldset>
        ...
        <div class="formelm">
            <label title="<?php echo JText::_('COM_TZ_PORTFOLIO_TYPE_OF_MEDIA')?>::<?php echo JText::_('COM_TZ_PORTFOLIO_TYPE_OF_MEDIA_DESC');?>"
                   class="hasTip required" for="jform_type_of_media" id="jform_type_of_media-lbl" aria-invalid="false">
        ...
        <div class="formelm">
            ...
            <input type="text" name="tz_tags" value="<?php echo $this -> listsTags;?>"
                   size="20"/><i><?php echo JText::_('COM_TZ_PORTFOLIO_FORM_TAGS_DESC');?></i>
        </div>
		<div class="formelm">
