...
require_once(JPATH_COMPONENT_ADMINISTRATOR.DS.'libraries'.DS.'autocuttext.php');
...
//        $this -> pagNav = new JPagination($total,$limitStart,$limit);
    ...
    function getArticle(){
        ...
        $query  = 'SELECT c.*,t.name AS tagName,YEAR(c.created) AS year,MONTH(c.created) AS month,u.name AS author,'
                  .'CONCAT_WS(":",YEAR(c.created),MONTH(c.created)) AS tz_date,'
