	...
	<fieldset id="filter-bar">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_state" class="inputbox" onchange="this.form.submit()">
				...
				<?php echo JHtml::_('select.options', TZ_PortfolioHelperUsers::getStateOptions(), 'value', 'text', $this->state->get('filter.state'));?>
			</select>
			...
			<select name="filter_active" class="inputbox" onchange="this.form.submit()">
				...
				<?php echo JHtml::_('select.options', TZ_PortfolioHelperUsers::getActiveOptions(), 'value', 'text', $this->state->get('filter.active'));?>
			</select>
			...
			<select name="filter_group_id" class="inputbox" onchange="this.form.submit()">
				...
				<?php echo JHtml::_('select.options', TZ_PortfolioHelperUsers::getGroups(), 'value', 'text', $this->state->get('filter.group_id'));?>
			</select>
			...
			<select name="filter_range" id="filter_range" class="inputbox" onchange="this.form.submit()">
				...
				<?php echo JHtml::_('select.options', TZ_PortfolioHelperUsers::getRangeOptions(), 'value', 'text', $this->state->get('filter.range'));?>
			</select>
		</div>
	</fieldset>
	<div class="clr"> </div>
		...
		?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<?php endif; ?>
<!--					--><?php //if (JDEBUG) : ?>
<!--						<div class="fltrt"><div class="button2-left smallsub"><div class="blank"><a href="--><?php //echo JRoute::_('index.php?option=com_tz_portfolio&view=debuguser&user_id='.(int) $item->id);?><!--">-->
