		...
		foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<?php endif; ?>
					<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_tz_portfolio&task=article.edit&return=featured&id='.$item->id);?>">
                ...
                <td class="center">
                    <a href="index.php?option=com_tz_portfolio&view=fieldsgroup&task=edit&cid[]=<?php echo $item -> groupid?>">
