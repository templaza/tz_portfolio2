...
?>
<form action="<?php echo JRoute::_('index.php?option=com_tz_portfolio&view=articles&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
