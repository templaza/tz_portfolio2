...
JModel::addIncludePath($com_path . '/models', 'TZ_PortfolioModel');
...
abstract class modTZ_PortfolioArticlesCategoryHelper
{
	public static function getList(&$params)
	{
		...
		$articles = JModel::getInstance('Articles', 'TZ_PortfolioModel', array('ignore_request' => true));
						...
						case 'article':
							if ($params->get('show_on_article_page', 1)) {
								...
								if (!$catid) {
									...
									$article = JModel::getInstance('Article', 'TZ_PortfolioModel', array('ignore_request' => true));
		...
		if ($catids) {
			if ($params->get('show_child_category_articles', 0) && (int) $params->get('levels', 0) > 0) {
				...
				$categories = JModel::getInstance('Categories', 'TZ_PortfolioModel', array('ignore_request' => true));
