...
require_once(JPATH_BASE.DS.'components'.DS.'com_tz_portfolio'.DS.'models'.DS.'media.php');
?>
...
<?php foreach ($list as $i => $item) :  ?>
	<li<?php if($i == 0) echo ' class="first"'; if($i == count($list)-1 ) echo ' class="last"'?>>
        ...
        <?php if($params -> get('show_image',0) == 1):?>
            <?php
                $model  = JModel::getInstance('Media','TZ_PortfolioModel',array('ignore_request' => true));
